...
import { NotificationsRequestHandler } from '../request-handlers/notifications.handler';
import { MessagesRequestHandler } from '../request-handlers/messages.handler';
import { ValidateUserSignUpGuard, ValidateUserSignInGuard } from '../validators/user.validator';
...
// POST
UsersRouter.post('/', ValidateUserSignUpGuard, UsersRequestHandler.sign_up);
...
// PUT
UsersRouter.put('/', ValidateUserSignInGuard, UsersRequestHandler.sign_in);
